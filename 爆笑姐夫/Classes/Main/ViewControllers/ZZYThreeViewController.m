...
#import "Header.h"
@interface ZZYThreeViewController ()

@end

@implementation ZZYThreeViewController
...
- (void)viewDidLoad {
    ...
    request.path = [NSString stringWithFormat:VIDEOPATH,currentPage];
