...
#import "Header.h"
@interface ZZYForthViewController ()

@end

@implementation ZZYForthViewController
...
- (void)viewDidLoad {
    ...
    request.path = [NSString stringWithFormat:NEWSPATH,currentPage];
