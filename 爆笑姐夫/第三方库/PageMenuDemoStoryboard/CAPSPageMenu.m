...
- (void)initValues
{
    ...
    _selectionIndicatorHeight             = 3.0;  //标示条的高度
    ...
    _selectedMenuItemLabelColor   = [UIColor whiteColor]; //已选字体颜色
    _unselectedMenuItemLabelColor = [UIColor lightGrayColor];//未选字体颜色
    _scrollMenuBackgroundColor    = [UIColor blackColor];//menu(滚动条)颜色
    _viewBackgroundColor          = [UIColor whiteColor];//背景色
    _bottomMenuHairlineColor      = [UIColor whiteColor];//menu下线的颜色
